...
const createReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.reviewService.createReviewIntoDB(id, req.body);
...
const getReviews = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reviews = yield review_service_1.reviewService.getAllReviewsFromDB();
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
